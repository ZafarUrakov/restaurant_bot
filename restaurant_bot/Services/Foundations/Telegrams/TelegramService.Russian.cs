...
namespace restaurant_bot.Services.Foundations.Telegrams
{
    public partial class TelegramService
    {
        ...
        private async Task HandleRussianLanguage(Update update)
        {
        ...
        {
            await HandleStartSectionCommandsAgainRu();
        ...
        private async Task HandleSettingsSectionRu()
        {
            switch (Text)
            {
                case "Изменить ФИО":
                    ...
                    break;
                case "Изменить номер":
                    await HandleChangeNumberRu();
                    break;
                case "🇷🇺 Выберите язык":
                    await HandleChangeLanguageRu();
                    break;
            }
        }
        ...
        private async Task HandleStartSectionCommandsAgainRu()
        {
            if (Text is "/start")
            {

...
namespace restaurant_bot.Services.Foundations.Telegrams
{
    public class TelegramService : ITelegramService
    {
        ...
        {
            await HandleStartSectionCommandsAgain();
            ...
            await HandleReviewMessage();

            await HandleSettingsSection();

            await HandleInputForPhoneNumber(Text);

            await HandleInputForName(Text);
        ...
        private bool IsButtonTitle(string input)
        {
        ...
        private async Task HandleSettingsSection()
        {
            switch (Text)
            {
                case "Изменить ФИО":
        ...
        private async Task HandleDishSelection()
        {
            switch (Text)
            {
                ...
                case "Самса с говядиной":
                    await SendSamsaWithBeefInformation();
                    break;
                case "Самса с курицей":
                    await SendSamsaWithChikenInformation();
                    break;
                case "Самса с фаршом":
                    await SendSamsaWithGroundMeatInformation();
                    break;
                case "Говядина кусковой":
                    await SendKebabWithBeefMeatInformation();
                    break;
                case "Баранина кусковой":
                    await SendKebabWithMuttonMeatInformation();
                    break;
                case "Люля Кебаб":
                    await SendLulaKebabInformation();
                    break;
                case "Ташкентский плов":
                    await SendPlovTashkentInformation();
                    break;
                case "Ферганский плов":
                    await SendPlovFerganaInformation();
                    break;
                case "Самаркандский плов":
                    await SendPlovSamarkandInformation();
                    break;
                case "Овощной":
                    await SendSalatOvoshnoyInformation();
                    break;
                case "Цезарь":
                    await SendSalatCezarInformation();
                    break;
                case "Оливье":
                    await SendSalatOlivieInformation();
                    break;
                case "Чай черный":
                    await SendBlackTeaInformation();
                    break;
                case "Чай зеленый":
                    await SendGreenTeaInformation();
                    break;
                case "Чай молочный":
                    await SendMilkTeaInformation();
                    break;
                case "Латте":
                    await SendLatteInformation();
                    break;
                case "Капучино":
                    await SendKapuchinoInformation();
                    break;
                case "Американо":
                    await SendAmericanoInformation();
                    break;
                case "Вода негазированная":
                    await SendWaterInformation();
                    break;
                case "Вода газированная":
                    await SendWaterGAZInformation();
                    break;
            }
        }
        ...
        private async Task HandleStartSectionCommandsAgain()
        {
            if (Text is "/start")
            {
        ...
        private async Task HandleReviewMessage()
        {
            switch (Text)
            {
                ...
                case "😊Все понравилось, на 5 ❤️":
                    await AddReviewsAndSendMessageAsync(Text);
                    break;
            }
        ...
        private async Task HandleInputForName(string text)
        {
        ...
        // Handle for phone
        private async Task HandleInputForPhoneNumber(string text)
        {
        ...
        private async Task HandleChangeName()
        {
            ...
            var markup = CreateChangeNameAndNumberMarkup();
        ...
        private async Task HandleChangeNumber()
        {
        ...
        private async Task HandleChangeLanguage()
        {
            string message = "🇷🇺 Выберите язык";

            var markup = CreateChangeLanguageMarkup();
        ...
        private async Task HandleSettingsCommand()
        {
            ReplyKeyboardMarkup markup = CreateSettingsMarkup();
        ...
        private async Task HandleReviewCommand()
        {
            ReplyKeyboardMarkup markup = CreateReviewMarkup();
        ...
        private async Task SendContactSupportMessage()
        {
            ReplyKeyboardMarkup markup = CreateOrderMarkup();
        ...
        private async Task SendInformationMessage()
        {
            ReplyKeyboardMarkup markup = CreateOrderMarkup();
        ...
        private static ReplyKeyboardMarkup CreateSettingsMarkup()
        {
            return new ReplyKeyboardMarkup(new KeyboardButton[][]
            {
                new KeyboardButton[]
        ...
        private static ReplyKeyboardMarkup CreateReviewMarkup()
        {
            // Individual buttons
        ...
        private static ReplyKeyboardMarkup CreateChangeNameAndNumberMarkup()
        {
            return new ReplyKeyboardMarkup(new[]
            {
                new[] { new KeyboardButton("⬅️ Назад") }
        ...
        private static ReplyKeyboardMarkup CreateChangeLanguageMarkup()
        {
            return new ReplyKeyboardMarkup(new[]
            {
        ...
        private Task<ReplyKeyboardMarkup> SendReadyOrderMessage()
        {
            ReplyKeyboardMarkup markup = new ReplyKeyboardMarkup(new KeyboardButton[][]
            {
            new KeyboardButton[]
        ...
        private async Task SendSamsaWithBeefInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendSamsaWithChikenInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendSamsaWithGroundMeatInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendKebabWithBeefMeatInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendKebabWithMuttonMeatInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendLulaKebabInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendPlovTashkentInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendPlovFerganaInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendPlovSamarkandInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendSalatOvoshnoyInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendSalatCezarInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendSalatOlivieInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendAmericanoInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendKapuchinoInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendLatteInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendBlackTeaInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendGreenTeaInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendMilkTeaInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendWaterGAZInformation()
        {
            await SendDishInformation(
        ...
        private async Task SendWaterInformation()
        {
            await SendDishInformation(
        ...
        private async Task AddReviewsAndSendMessageAsync(string score)
        {
            var user = RetrieveUser();
